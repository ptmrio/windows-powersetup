...
Public MIT PowerShell GUI (`Windows-PC-Setup.ps1`, v2.4) for IT admins setting up Windows 10/11 PCs. Single-file WinForms. Do not split the script unless asked.
...
4. Harden (optional standard user, Defender/SmartScreen/ASR, 10-min lock, Store-only + SAC with Unlock)
